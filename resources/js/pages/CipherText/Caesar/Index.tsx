...
const breadcrumbs: BreadcrumbItem[] = [{ title: 'Caesar Cipher', href: '' }];
...
const N8N_WEBHOOK_URL = 'https://n8n.larable.dev/webhook/17117f6e-50bb-446a-9e2e-7b70b9c7bd95';
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                const output = data.ciphertext || data.plaintext || 'No result returned.';
                setResult(output);
                ...
                for (let i = 0; i < upperText.length; i++) {
                    ...
                    if (inputValue === -1) continue; // skip non-alphabet
                    const shiftValue = Number(shift);
                    const resultChar = upperOutput[i];
                    newSteps.push({ inputChar, inputValue, shiftValue, resultChar });
                }
                setSteps(newSteps);
            ...
            setStatus({
                message: 'Network Error: Could not reach the webhook URL. Check your connection or n8n CORS settings.',
                type: 'error',
            });
        } finally {
            setIsLoading(false);
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="font-inter flex min-h-screen flex-col items-center justify-center bg-gray-50 p-4 dark:bg-gray-900">
                <Card title="Caesar Cipher Calculator">
                        ...
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                            ...
                            <div className="md:col-span-1">
                                ...
                                <Textarea
                                    ...
                                    rows={8}
                                />
                                <Button type="submit" isLoading={isLoading} disabled={!text || shift < 1 || shift > 25} className="mt-4">
                    ...
                    {steps.length > 0 && (
                        <div className="mt-6">
                            <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">
                                Caesar Cipher Steps ({mode === 'encrypt' ? 'Encryption' : 'Decryption'})
                            </h3>
                            <table className="w-full border-collapse border border-gray-300 dark:border-gray-600">
                                <thead>
                                    <tr className="bg-gray-200 dark:bg-gray-700">
                                        ...
                                        <th className="border border-gray-300 dark:border-gray-600 px-4 py-2">Shift</th>
                                ...
                                <tbody>
                                    {steps.map((step, index) => (
                                        <tr key={index} className="odd:bg-white even:bg-gray-50 dark:odd:bg-gray-900 dark:even:bg-gray-800">
                                            ...
                                            <td className="border border-gray-300 dark:border-gray-600 px-4 py-2">{step.shiftValue}</td>
                    ...
                    <a
                        href="https://caesarcipher.larable.dev/"
                        target="_blank"
